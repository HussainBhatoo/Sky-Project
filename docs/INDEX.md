...
This index is the single entry point for project documentation.
...
- [Auth/Login-Signup](audit/auth_login_signup.md)
...
- [Database Spec](implementation/DATABASE_SPEC.md)
- [Entity Evolution](implementation/ENTITY_LOG.md)
- [Inter-App Wiring](implementation/INTER_APP_WIRING.md)
- [Group Workflow](process/GROUP_WORKFLOW.md)
- Student module docs:
  - [Riagul - Teams](implementation/students/riagul_teams.md)
  - [Lucas - Organisation](implementation/students/lucas_organisation.md)
  - [Suliman - Messages](implementation/students/suliman_messages.md)
  - [Maurya - Schedule](implementation/students/maurya_schedule.md)
