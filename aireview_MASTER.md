...
| Maurya Patel | `core/*`, `schedule/*`, `assets/css/*`, `templates/base.html`, `templates/admin/*` | 🔴 HIGH | Owns 4 of 5 highest-risk files (admin, signals, middleware, tests) plus 1,366 LOC CSS system |
...
| 2 | Fix role swap in student reflections | `docs/student_reflections/hussain.md`, `suliman_roshid.md` | Removes obvious internal contradiction | 20 min |
| 3 | Complete `docs/legal_ethical.md` (delete `...[BCS content]...` placeholder) | 1 file | Gains rubric marks AND removes AI flag | 45 min |
| 4 | Move `CWK2_MASTER_PLAN.md` outside repo or trim to <300 lines | 1 file | 1,917-line internal plan is atypical Y2 | 15 min |
| 5 | Delete `SkyAdminSite` in `core/admin.py`, use vanilla `admin.site.register` | `core/admin.py` | Removes biggest Python-side AI red flag | 30 min |
...
| 10 | Rewrite README.md opening — drop "Production-Ready / 100% compliant" marketing | 1 file | Removes obvious marketing-copy tone | 20 min |
