...
5. **Fill in individual + group `.docx` templates** with file/authorship lists, peer feedback (7+ instances per student), mentor reflection (5 questions), test plan, version control description. This alone covers ~50 marks of rubric items currently marked MISSING.
